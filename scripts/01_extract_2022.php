...
foreach(glob('/home/kiang/public_html/ardata.cy.gov.tw/data/individual/account/111年*/*/*.zip') AS $zipFile) {
...
file_put_contents(dirname(__DIR__) . '/report/01_extract_2022.json', json_encode($openGroups));